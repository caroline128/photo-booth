...
| 机器 | 线下原型（见调研） | 这台机器的玩法 |
|---|---|---|
| **PHOTOMATIC** 复古黑白胶片机 | 欧美化学显影照相亭：4 次闪光，3–4 分钟后拿到湿的四格竖条 | 4 连拍、硬闪/柔光可选，黑白/棕褐/蓝晒冲洗；打印时有「曝光 → 显影 → 定影 → 烘干」动画，照片出来后慢慢显影 |
| **STAR 4CUT** K-POP 人生四格 | 韩国自助照相馆：拍 8–10 张、每张约 10 秒，挑 4 张，一次打印两条 | 8 张 × 10 秒倒数，遥控快门，挑 4 张；竖条 / 2×2 / 偶像小卡版式；韩系换色背景、应援贴纸 |
| **FISHEYE CAM** 鱼眼大头机 | 韩国租赁机的平视鱼眼「门铃视角」 | WebGL 鱼眼镜头，可调强度；猫眼圆框、监控画面版式 |
| **PURI☆PARA** Y2K 辣妹大头贴 | 日本プリ机：おまかせ 6 张，涂鸦台 3–5 分钟，平成风和荧光笔回潮 | 「盛れ」美颜（美白、大眼）、豹纹/斑马/星星背景、3 分钟涂鸦、贴纸大张 |
| **DIGI 2003** 千禧 CCD 大头贴 | CCD 怀旧：颗粒、闪光过曝、橙色日期戳；千禧「非主流」 | 低像素传感器质感、闪光开关、日期戳可「穿越」回 2005，4×4 迷你贴纸 |
| **抽象表情包机** MEME BOOTH | 国内热梗、方言模板大头贴（38 元 9 张） | 9 张 × 3 秒快拍，每张配一句热梗，拼成表情包九宫格 |
...
3. **选相框**：先选版式，再选相框，每一步都有倒计时，时间到自动选定。
4. **机器专属选项**：比如闪光灯、鱼眼强度、美颜程度、日期戳。
...
8. **滤镜**（表情包机还有「配字」）。
9. **涂鸦**：贴纸、文字、多种画笔（霓虹、描边、亮片、爱心印章、喷漆、粉笔等），限时完成。可以放大到单张照片来装饰。
