...
export default {
  ...
  fonts: {
    ...
    load: ['Press Start 2P', 'VT323', 'ZCOOL KuaiLe', 'ZCOOL QingKe HuangYou', 'Pacifico', 'Caveat'],
    text: FRAME_TEXT,
  },
  ...
  filters: [
    ...
    { id: 'night', name: '夜景模式', desc: '暗 · 噪点 · 偏蓝', fx: { exposure: -0.8, temp: -0.85, tint: -0.2, grain: 0.8, jpeg: 0.5, saturation: 0.7, contrast: 1.25, vignette: 0.6 } },
    { id: 'dreamy', name: '非主流梦幻', desc: '粉色柔光 · 高饱和', fx: { glow: 0.55, temp: 0.3, tint: -0.75, saturation: 1.35, exposure: -0.05, fade: 0.12, sharpen: 0, vignette: 0.3 } },
  ...
  textStyles: [
    ...
    { name: 'Pacifico', font: '"Pacifico", "ZCOOL KuaiLe", cursive', color: '#2f6bff', gradient: ['#6fb6ff', '#1f47b8'], stroke: '#ffffff', strokeWidth: 0.14, outline: 0.04, outlineColor: '#1f47b8', chip: '#eaf2ff' },
  ],
